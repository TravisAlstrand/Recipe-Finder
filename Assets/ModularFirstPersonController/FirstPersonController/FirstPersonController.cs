...
public class FirstPersonController : MonoBehaviour
{
    ...
    public Sprite interactCrosshairImage;
    public Color crosshairColor = Color.white;
    public float crosshairScale = 8f;
    public Color interactCrosshairColor = Color.yellow;
    public float interactCrosshairScale = 10f;
    ...
    void Start()
    {
        ...
        if(crosshair)
        {
            ...
            crosshairObject.GetComponentInParent<CanvasScaler>().scaleFactor = crosshairScale;
        }
        else
        {
    ...
    private void Update()
    {
        ...
        if (Physics.Raycast(ray, out hit, _maxInteractDistance))
        {
            Interactable interactable = hit.collider.GetComponent<Interactable>();

            if (interactable != null)
            {
                crosshairObject.sprite = interactCrosshairImage;
                crosshairObject.color = interactCrosshairColor;
                crosshairObject.GetComponentInParent<CanvasScaler>().scaleFactor = interactCrosshairScale;
